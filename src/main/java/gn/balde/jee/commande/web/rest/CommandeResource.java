package gn.balde.jee.commande.web.rest;

import gn.balde.jee.commande.domain.Commande;
import gn.balde.jee.commande.repository.CommandeRepository;
import gn.balde.jee.commande.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link gn.balde.jee.commande.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommandeResource {
    ...
    private static final String ENTITY_NAME = "commandeCommande";

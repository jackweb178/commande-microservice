...
import gn.balde.jee.commande.domain.Product;
import gn.balde.jee.commande.repository.ProductRepository;
...
/**
 * REST controller for managing {@link gn.balde.jee.commande.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "commandeProduct";
